...
<html>
<head>
    <title>Actualizar Perfil | Sistema de Gestión de Empleados</title>
    <!-- Icons font CSS-->
    ...
    <header>
        <nav>
            ...
            <ul id="navli">
                ...
                <li><a class="homered" href="myprofile.php?id=<?php echo $id; ?>">Mi Perfil</a></li>
    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Actualizar Información del Empleado</h2>
                    <form id="registration" action="myprofileup.php" method="POST">
                        ...
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--green" type="submit" name="update">Enviar</button>
                        </div>
                        
                    </form>
                    <br>
                    <button class="btn btn--radius btn--green" onclick="window.location.href = 'changepassemp.php?id=<?php echo $id; ?>';">Cambiar Contraseña</button>
                </div>
            </div>
        </div>
    </div>
