...
<html>
<head>
    <title>Marca del Proyecto | Sistema de Gestión de Empleados</title>
    <!-- Icons font CSS-->
    ...
    <header>
        <nav>
            ...
            <ul id="navli">
                ...
                <li><a class="homeblack" href="empleave.php">Permisos de Empleados</a></li>
    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Marca del Proyecto</h2>
                    <form id="registration" action="mark.php" method="POST">
                        ...
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--green" type="submit" name="update">Asignar Marca</button>
                        </div>
